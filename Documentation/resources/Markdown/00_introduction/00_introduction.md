...
The STSAFE-A120 example package offers developers a collection of applicative examples demonstrating the use of the STSAFE-A120 secure element product line from STMicroelectronics. These examples can serve as software reference implementations for integrating STSAFE-A/STSAFE-L devices on host microcontroller platforms. 

## Software package content 

The software package includes a set of drivers, middleware, and examples for various STM32 microcontrollers.

![Software Package Architecture](./Software_package_architecture.png)

- **Application Layer**

  This layer contains a set of STM32 Cube IDE project use case examples that illustrate the use of STSAFE-A and STSAFE-L Secure Elements on the different hardware development platforms provided by STMicroelectronics.

- **Middleware Layer**

  - **[STM32 Cryptographic Library (CMOX)](../../../Middleware/STM32_Cryptographic/Release_Notes.html)**

    The STM32 cryptographic library (CMOX) includes all the major security algorithms for encryption, hashing, message authentication, and digital signing. Detailed documentation on the STM32 Cryptographic Middleware version included in this software package is available in [/Middleware/STM32_Cryptographic](./../../../Middleware/STM32_Cryptographic/Release_Notes.html). 

  - **STSecureElement Library (STSELib)**

    Middleware providing a complete set of high-level APIs and core services to interface with the STMicroelectronics Secure Element device family. Detailed documentation on the STELib version included in this software package is available in [/Middleware/STSELib/doc/](./../../../Middleware/STSELib/doc/documentation.html). 
...
- **Platforms**
  ...
  - <b>Hardware prerequisites</b> 
    ...
    - X-NUCLEO-STSAFEA1 or X-NUCLEO-SAFEL01 expansion board 
    - 1x micro USB cable 
...
> **Note:** Jumper P7 (RST control) must be left open to communicate with the target STSAFE-A120.
